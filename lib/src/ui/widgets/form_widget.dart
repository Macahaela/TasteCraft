...
Widget textfieldIcon({
  ...
  TextInputType? keyboardType, // Menambahkan parameter keyboardType
}) {
  return Padding(
    ...
    child: Column(
      ...
      children: [
        TextFormField(
          ...
          keyboardType:
              keyboardType, // Meneruskan keyboardType ke TextFormField
...
Widget textfieldOTP({
  ...
  required int length,
  required Function(String) onChanged, // Add this parameter
}) {
  return PinCodeTextField(
    ...
    onCompleted: (value) {}, // Optional: Keep this if needed
    onChanged: onChanged, // Assign the parameter here
  );
}
